    ...
    <div id="editor-main-container" class="editor flex-main flex-rows">
      <div style="margin:3px;">
        <div class="btn-input">
          ...
          <button type="text" onclick="copyUrlToClipboard()" >图片生成短链并分享</button>
        </div>
      </div>
      <div style="margin:3px;">
        <div class="btn-input">
          <input id="source_url" type="text" name="source_url" value="uml/<%= diagramUrl %>" />
          <button type="text" onclick="copySourceUrlToClipboard()" >源码生成短链并分享</button>
        </div>
      </div>
